          ...
          <form className={classes.form}>
            ...
            >
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The ChatSphere Terms & Conditions"
              ...
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The  ChatSphere Terms Of Use"
                  className={classes.checkbox}
                />
              </Grid>
            </Grid>
            ...
            >
              I acknowledge ChatSphere will use my information in accordance
              with its
